                ...
                <p className='block text-transparent'>...</p>
                    ...
                    <div className="PackageContainer">
                            ...
                            >
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text className='Desc'>Duration : 3 Months</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 10,000 Per Month. </Card.Text>
                            ...
                            >
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text className='Desc'>Duration : 4 Months</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 10,000 Per Month. </Card.Text>
                                ...
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    ...
                                    <Card.Body>
                                        ...
                                        UI/UX design focuses on crafting  visually appealing interfaces and enhancing user experiences by ensuring seamless interaction between users products or applications.
                                         ...
                                         <Card.Text className='Desc'>Duration : 5 Months</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 8,000 Per Month. </Card.Text>
                                        <a href="https://calendly.com/quicktechcollege/15min" target='_blank'><Button variant='primary'>Learn More</Button></a>
                                    </Card.Body>
                                </Card>
                        </motion.div>
                            ...
                            >
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    ...
                                    <Card.Body>
                                      ...
                                      <Card.Text className='Desc'>Duration : 2 Months</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 15,000 Per Month. </Card.Text>
                                        <a href="https://calendly.com/quicktechcollege/15min" target='_blank'><Button variant='primary'>Learn More</Button></a>
                                    </Card.Body>
                                </Card>
                        </motion.div>
                                ...
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    ...
                                    <Card.Body>
                                        ...
                                        HTML (Hypertext Markup Language) structures web content using elements like headings, paragraphs, and links. It defines the content and layout, serving as the foundation for many web pages and applications.
                                         ...
                                         <Card.Text className='Desc'>Duration : 1 Month</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 5,000 Per Month. </Card.Text>
                                        <a href="https://calendly.com/quicktechcollege/15min" target='_blank'><Button variant='primary'>Learn More</Button></a>
                                    </Card.Body>
                                </Card>
                        </motion.div>
                            ...
                            >
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text className='Desc'>Duration : 3 Months</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 12,000 Per Month. </Card.Text>
                                        <a href="https://calendly.com/quicktechcollege/15min" target='_blank'><Button variant='primary'>Learn More</Button></a>
                                    </Card.Body>
                                </Card>
                        </motion.div>
                            ...
                            >
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    ...
                                    <Card.Body>
                                       ...
                                       <Card.Text className='Desc'>Duration : 2 Months</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 4,000 Per Month. </Card.Text>
                                        <a href="https://calendly.com/quicktechcollege/15min" target='_blank'><Button variant='primary'>Learn More</Button></a>
                                    </Card.Body>
                                </Card>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            >
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    ...
                                    <Card.Body>
                                        <Card.Title className='Desc'>Basic Networking</Card.Title>
                                        <Card.Text className='Desc'>
                                        Basic Computer networking is the process of connecting devices to allow them to share data and resources. It involves using a set of rules, called communications protocols, to transmit information over physical or wireless connections. 
                                        </Card.Text>
                                        <Card.Text className='Desc'>Duration : 2 Months</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 5,000 Per Month. </Card.Text>
                                        <a href="https://calendly.com/quicktechcollege/15min" target='_blank'><Button variant='primary'>Learn More</Button></a>
                        ...
                        <motion.div
                            ...
                            >
                                <Card style={{ width: '' , height:'',}} className='Cards'>
                                    <Card.Img variant="top" src={WPS} />
                                    <Card.Body>
                                        <Card.Title className='Desc'>Word press, Joomla Or Drupal</Card.Title>
                                        <Card.Text className='Desc'>
                                        WordPress (WP, or WordPress.org) is a web content management system. It was originally created as a tool to publish blogs but has evolved to support publishing other web content
                                        </Card.Text>
                                        <Card.Text className='Desc'>Duration : 1 Month</Card.Text>
                                        <Card.Text className='Desc'>Starts At : 5,000 Per Month. </Card.Text>
                                        <a href="https://calendly.com/quicktechcollege/15min" target='_blank'><Button variant='primary'>Learn More</Button></a>
